...
//#ifdef TARGET_CRYPTO_CAP
    for (i = 0; i < CAPREG_SIZE; i++) {    
        qemu_fprintf(f, "CR%01d.perms=%04" PRIx16 ":.base=%012" PRIx64 ":.offset=%08" PRIx32 ":.size=%08" PRIx32  ":.PT=%016" PRIx64 ":.MAC=%016" PRIx64 "%s" , i, 
    ...
    qemu_fprintf(f, "CCLC.PC=%016" PRIx64 ":.SP=%016" PRIx64 ":.PT=%016" PRIx64 ":.MAC=%016" PRIx64 "%s", env->cclc.FIELD[0], env->cclc.FIELD[1], env->cclc.FIELD[2], env->cclc.FIELD[3], "\n");  
    qemu_fprintf(f, "CCLR.PC=%016" PRIx64 ":.SP=%016" PRIx64 ":.PT=%016" PRIx64 ":.MAC=%016" PRIx64 "%s", env->cclr.FIELD[0], env->cclr.FIELD[1], env->cclr.FIELD[2], env->cclr.FIELD[3], "\n");  
    qemu_fprintf(f, "PCLC.TARGET=%016" PRIx64 ":.HOST=%016" PRIx64 ":.PC=%016" PRIx64 ":.MAC=%016" PRIx64 "%s", env->pclc.FIELD[0], env->pclc.FIELD[1], env->pclc.FIELD[2], env->pclc.FIELD[3], "\n");  
    qemu_fprintf(f, "PCLR.TARGET=%016" PRIx64 ":.HOST=%016" PRIx64 ":.PC=%016" PRIx64 ":.MAC=%016" PRIx64 "%s", env->pclr.FIELD[0], env->pclr.FIELD[1], env->pclr.FIELD[2], env->pclr.FIELD[3], "\n");  
    qemu_fprintf(f, "DCLC.FIELD[0]=%016" PRIx64 ":.FIELD[1]=%016" PRIx64 ":.FIELD[2]=%016" PRIx64 ":.FIELD[3]=%016" PRIx64 ":.FIELD[4]=%016" PRIx64 ":.FIELD[5]=%016" PRIx64 ":.FIELD[6]=%016" PRIx64 ":.FIELD[7]=%016" PRIx64 ":.FIELD[8]=%016" PRIx64  ":.FIELD[9]=%016" PRIx64 ":.FIELD[10]=%016" PRIx64  ":.FIELD[11]=%016" PRIx64  "%s", env->dclc.FIELD[0], env->dclc.FIELD[1], env->dclc.FIELD[2], env->dclc.FIELD[3], env->dclc.FIELD[4], env->dclc.FIELD[5], env->dclc.FIELD[6], env->dclc.FIELD[7], env->dclc.FIELD[8], env->dclc.FIELD[9], env->dclc.FIELD[10], env->dclc.FIELD[11],"\n");  
    qemu_fprintf(f, "DCLR.FIELD[0]=%016" PRIx64 ":.FIELD[1]=%016" PRIx64 ":.FIELD[2]=%016" PRIx64 ":.FIELD[3]=%016" PRIx64 ":.FIELD[4]=%016" PRIx64 ":.FIELD[5]=%016" PRIx64 ":.FIELD[6]=%016" PRIx64 ":.FIELD[7]=%016" PRIx64 ":.FIELD[8]=%016" PRIx64  ":.FIELD[9]=%016" PRIx64 ":.FIELD[10]=%016" PRIx64  ":.FIELD[11]=%016" PRIx64  "%s", env->dclr.FIELD[0], env->dclr.FIELD[1], env->dclr.FIELD[2], env->dclr.FIELD[3], env->dclr.FIELD[4], env->dclr.FIELD[5], env->dclr.FIELD[6], env->dclr.FIELD[7], env->dclr.FIELD[8], env->dclr.FIELD[9], env->dclr.FIELD[10], env->dclr.FIELD[11],"\n");  
...
static const TCGCPUOps arm_tcg_ops = {
    ...
    .tlb_fill_crca = arm_cpu_tlb_fill_crca,
